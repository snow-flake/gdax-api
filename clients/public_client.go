...
type IGdaxPublicClient interface {
	Get(path string, params url.Values, target interface{}) error
}

type HttpGdaxPublicClient struct {
	Domain string
}

func (client *HttpGdaxPublicClient) Get(path string, params url.Values, target interface{}) error {
...
func GetProducts(client IGdaxPublicClient) (GdaxProductsResponse, error) {
	// Get Products
	...
	err := client.Get("/products", url.Values{}, &output)
	return output, err
}
...
func GetTime(client IGdaxPublicClient) (*GdaxTimeResponse, error) {
...
func GetCurrencies(client IGdaxPublicClient) (GdaxCurrenciesResponse, error) {
	// Currencies
	// Get currencies
	...
	err := client.Get("/currencies", url.Values{}, &tmp)
...
func GetProduct24HrStats(client IGdaxPublicClient, product_id string) (*GdaxProduct24HrStatsResponse, error) {
	// Get 24hr Stats
	...
	tmp := &AutoGeneratedResponse{}
	err := client.Get(fmt.Sprintf("/products/%s/stats", product_id), url.Values{}, tmp)
...
func GetProductHistoricRates(client IGdaxPublicClient, product_id string, start *time.Time, end *time.Time, granularity HistoricRateGranularity) (GdaxProductHistoricRatesResponse, error) {
	// Get Historic Rates
	...
	tmp := [][]json.Number{}
	err := client.Get(fmt.Sprintf("/products/%s/candles", product_id), args, &tmp)
...
func GetProductTrades(client IGdaxPublicClient, product_id string) (GdaxProductTradesResponse, error) {
	// Get Trades
	...
	tmp := []AutoGeneratedResponse{}
	err := client.Get(fmt.Sprintf("/products/%s/trades", product_id), url.Values{}, &tmp)
...
func GetProductTicker(client IGdaxPublicClient, product_id string) (*GdaxProductTickerResponse, error) {
	// Get Product Ticker
	...
	tmp := &AutoGeneratedResponse{}
	err := client.Get(fmt.Sprintf("/products/%s/ticker", product_id), url.Values{}, tmp)
...
func GetProductOrderBookLevel1(client IGdaxPublicClient, product_id string) (*GdaxProductOrderBookResponseLevel1, error) {
	args := url.Values{
		"level": []string{"1"},
	}
	tmp := map[string]interface{}{}
	err := client.Get(fmt.Sprintf("/products/%s/book", product_id), args, &tmp)
	if nil != err {
		return nil, err
	}
...
func GetProductOrderBookLevel2(client IGdaxPublicClient, product_id string) (*GdaxProductOrderBookResponseLevel2, error) {
	args := url.Values{
		"level": []string{"2"},
	}
	tmp := map[string]interface{}{}
...
func GetProductOrderBookLevel3(client IGdaxPublicClient, product_id string) (*GdaxProductOrderBookResponseLevel3, error) {
	args := url.Values{
		"level": []string{"3"},
	}
	tmp := map[string]interface{}{}
